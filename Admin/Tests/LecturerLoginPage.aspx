<%@ Page Title="lecturer Login Page" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="LecturerLoginPage.aspx.cs" Inherits="AttendanceManagementSystem.Admin.Tests.LecturerLoginPage" %>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Button ID="LoginButton" runat="server" Text="Login" CssClass="btn btn-default pull-right" OnClick="LoginButton_Click" />
                </div>
